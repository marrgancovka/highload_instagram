...
| User      | 9416600     | -           | 
| Profile   | 9416600     | -           | 
| Post      | 2 604 150   | 1 075       | 
| Comment   | 2 604 150   | 14 467      | 
| Like      | 2 604 150   | 121 528     |
| Followers | 2 000       | 1 446       |
...
|------------------------------------------|---------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Рекомендательный алгоритм                | Генерация ленты новостей, подбор релевантного контента        | Поддержание высокого уровня вовлеченности, повышение вероятности удержания пользователя и увеличения времени взаимодействия с платформой за счёт персонализированного контента. |
| Обработка комментариев, спама и контента | Модернизация комментариев, выявление нежелательного контентов | Защита пользователей от нежелательного, жестокого контента для поддержания позитивной атмосферы на платформе и улучшения пользовательского опыта.                               |
| Социальный граф                          | Поддержка структуры связей между пользователями ( подписчики) | Построение сети взаимодействия между пользователями для увеличения вовлеченности и персонализации контента, с учётом географической близости и нагрузки.                        |
